...
">
      <div className="container">
        <Link href="/" className="navbar-brand animate__animated  animate__shakeY">
          Vishvajeet
        </Link>
        <button
        ...
        <div className={`collapse navbar-collapse ${isOpen ? 'show' : ''}`} id="navbarNav">
          <ul className="navbar-nav ms-auto">
            <li className={`nav-item ${router.pathname == '/' ? 'active' : ''}`}>
              <Link href="/" className="nav-link animate__animated  animate__shakeY">
                Home
              </Link>
            </li>
            <li className={`nav-item ${router.pathname == '/about' ? 'active' : ''}`}>
              <Link href="/about" className="nav-link  animate__animated  animate__shakeY">
                About
              </Link>
            </li>
            <li className={`nav-item ${router.pathname == '/services' ? 'active' : ''}`}>
              <Link href="/services" className="nav-link  animate__animated  animate__shakeY">
                Services
              </Link>
            </li>
            <li className={`nav-item ${router.pathname == '/contact' ? 'active' : ''}`}>
              <Link href="/contact" className="nav-link  animate__animated  animate__shakeY">
                Contact
              </Link>
            </li>
          </ul>
            ...
            <div className="heading">
                <h1 className="text_heading    animate__animated  ">Login your Account here</h1>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form">
                        ...
                        <button type="submit" className='login_btn    animate__backOutUp'>Login</button>
                ...
                <div className="authentication  animate__animated rotateInDownLeft">
                    <h3 className='animate__animated  animate__zoomIn'>Login with Social Media</h3>
                    <div className="box" >
